...
import { gardenAndKitchen } from '../../../../public/static/data/home-1';

class GardenAndKitchen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            currentProducts: gardenAndKitchen.newArrivals,
    ...
    render() {
        ...
        const { newArrivals, mostPopular, bestSeller } = gardenAndKitchen;
